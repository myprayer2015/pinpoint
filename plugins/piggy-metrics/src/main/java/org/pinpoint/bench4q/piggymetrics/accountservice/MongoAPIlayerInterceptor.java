...
public class MongoAPIlayerInterceptor implements TransformCallback {
	...
	public byte[] doInTransform(Instrumentor instrumentor, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
		...
		InstrumentMethod targetMethod = target.getDeclaredMethod("getConnector");
		...
		// 2. Get InstrumentMethod of the target method.
		InstrumentMethod targetMethodx = target.getDeclaredMethod("command", "com.mongodb.DBObject");
