...
public class MongoPropertiesInterceptor implements TransformCallback {
	...
	public byte[] doInTransform(Instrumentor instrumentor, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
		...
		InstrumentMethod targetMethod = target.getDeclaredMethod("createMongoClient","com.mongodb.MongoClientOptions","org.springframework.core.env.Environment");
