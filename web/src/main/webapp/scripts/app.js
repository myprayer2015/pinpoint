...
pinpointApp.config(['$routeProvider', '$locationProvider', '$modalProvider', function ($routeProvider, $locationProvider, $modalProvider) {
    ...
    }).when('/oncecloud/hosts/add/', {//主机新增
        templateUrl: 'pages/oncecloud/hosts/hosts-add.html',
        controller: 'OnceHostsAddCtrl'
    }).when('/oncecloud/hosts/items/', {//主机监控项
        templateUrl: 'pages/oncecloud/hosts/hosts-items.html',
        controller: 'OnceHostsItemsCtrl'
    }).when('/oncecloud/hosts/items-chart/', {//主机监控项数据图表
        templateUrl: 'pages/oncecloud/hosts/hosts-items-chart.html',
        controller: 'OnceHostsItemsChartCtrl'
    ...
    }).when('/oncecloud/tracelist/', {
        templateUrl: 'pages/oncecloud/trace/trace_list.html',
        controller: 'OnceTracesListCtrl'
